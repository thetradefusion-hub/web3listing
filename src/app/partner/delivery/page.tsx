            ...
            return (
              <PartnerPanel key={order.id}>
                ...
                <PartnerPanelBody>
                  ...
                  <Link href={`/partner/orders/${order.id}/delivery`} className="mt-4 inline-block text-sm font-semibold text-[#059669] hover:underline">
                    View Full Delivery →
                  </Link>
                  <Link href={`/partner/orders/${order.id}`} className="mt-2 block text-sm font-medium text-[#635BFF] hover:underline">
                    Order Details
                  </Link>
                </PartnerPanelBody>
              </PartnerPanel>
