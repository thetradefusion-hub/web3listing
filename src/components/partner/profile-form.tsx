...
import { PartnerPanel, PartnerPanelHeader, PartnerPanelBody } from "@/components/partner/ui";
...
export function ProfileForm({ profile }: { profile: Profile }) {
  ...
  return (
    <div className="space-y-6">
      <PartnerPanel>
        <PartnerPanelHeader title="Profile Information" />
        <PartnerPanelBody>
      ...
      <PartnerPanel>
        <PartnerPanelHeader title="Change Password" />
        <PartnerPanelBody>
