...
export default function ParticleText({
  ...
  useEffect(() => {
    ...
    const render = (now: number) => {
      ...
      particles.forEach((particle) => {
        ...
        ctx.globalAlpha = clamp(minOpacity + progress * (1 - minOpacity), 0, 1);
    ...
    const sampleText = async () => {
      ...
      const offsetX = align === "left" ? 0 : width / 2 - offscreen.width / 2;
      ...
      pointer.x = align === "left" ? offscreen.width / 2 : width / 2;
      pointer.y = height / 2;
  ...
  return (
    <div
      ref={containerRef}
      className={cn("particle-text", className)}
      style={style}
      aria-label={text}
    >
