    ...
    <section className="landing-section border-y landing-section-alt">
      <div className="landing-container">
        ...
        <div className="relative">
          <div className="pointer-events-none absolute left-0 right-0 top-[2.75rem] hidden h-px bg-gradient-to-r from-transparent via-cyan-500/30 to-transparent xl:block" />
              ...
              <div key={step.step} className="group relative min-w-0">
                <div className="landing-card flex h-full flex-col p-4 transition-all duration-300 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 sm:p-5">
                  <div className="mb-3 flex items-center gap-3 sm:mb-4">
                    <span className="flex size-10 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-500/20 to-violet-500/10 text-sm font-extrabold text-cyan-700 ring-1 ring-cyan-500/20 sm:size-11 dark:text-cyan-300">
                      {step.step}
                    </span>
                    {index < HOW_IT_WORKS.length - 1 ? (
                      <span className="hidden h-px flex-1 bg-gradient-to-r from-cyan-500/25 to-transparent xl:block" />
                    ) : null}
                  </div>
