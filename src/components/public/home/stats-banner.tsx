  ...
  return (
    <section className="landing-section landing-section-alt landing-surface-deep relative overflow-hidden border-y">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute bottom-0 left-1/2 h-px w-1/2 -translate-x-1/2 bg-gradient-to-r from-transparent via-chart-2/30 to-transparent" />
      </div>
      ...
      <div className="landing-container relative">
        ...
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 sm:gap-3 lg:grid-cols-6">
          {PLATFORM_STATS.map((stat) => (
            ...
            >
              <p className="lh-stat-value text-foreground transition group-hover:text-primary dark:group-hover:text-chart-2">
                {stat.value}
              </p>
        ...
        <div className="mt-8 flex justify-center sm:mt-12">
          <Button
            size="lg"
            className="lh-btn-cta h-11 w-full max-w-sm rounded-xl text-sm font-semibold sm:h-12 sm:w-auto sm:max-w-none sm:rounded-full sm:px-8"
            asChild
          >
            <Link href="/contact">
